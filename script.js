let upload_img_Btn = document.querySelector(".upload_img button");
let upload_Input = document.querySelector(".upload_img input");
...
upload_img_Btn.addEventListener("click", () => upload_Input.click());
